...
def Conv_block_(input_layer, F1=4, kernLength=64, poolSize=8, D=2, in_chans=22,
    ...
    block1 = BatchNormalization(axis=-1, name='bn1')(block1)
    ...
    block2 = DepthwiseConv2D((1, in_chans + 4), depth_multiplier=D, data_format='channels_last',
